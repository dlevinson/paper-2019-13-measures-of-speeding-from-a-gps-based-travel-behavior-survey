...
global title2
title2 = ['Longitude','Latitude','Speed(kilometer)','DD/MM/YY','HH:MM:SS','GX','GY','Min_hight','Streetname', 'Streetlength', 'Roadtype','Speedlimit(mph)', 'LinkID']
...
def nearlink():
	...
	for row in islice(gps_reader, 1, None):
		...
		if min_height < 30:
			...
			LinkID = str(linkID)
			list.extend([longitude, latitude, speed, date, hms, GX, GY, Min_height, Streetname, Streetlength, Roadtype, Speedlimit, LinkID])
